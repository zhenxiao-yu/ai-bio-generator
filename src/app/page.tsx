...
const Footer = () => (
  <footer className="py-6 bg-gray-100 dark:bg-gray-800 text-center">
    <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300 px-4 md:px-0">
      © 2024 Zhenxiao Yu. All rights reserved. Check out more projects at{" "}
      <a href="https://m4rkyu.com" className="text-blue-500 hover:underline">m4rkyu.com</a>.
    </p>
  </footer>
);
